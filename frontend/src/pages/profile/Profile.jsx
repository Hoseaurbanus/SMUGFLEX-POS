            ...
            <div className="card-body">
              ...
              <table className="table table-dark table-sm mb-0">
                <tbody>
                  ...
                  <tr><td>Role</td><td>{user.role_name || user.role?.name || '-'}</td></tr>
                  <tr><td>Branch</td><td>{user.branch_name || '—'}</td></tr>
                  <tr><td>Status</td><td><span className={`badge bg-${user.is_active ? 'success' : 'secondary'}`}>{user.is_active ? 'Active' : 'Inactive'}</span></td></tr>
